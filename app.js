...
var taskInput=document.querySelector('.add-task-form__input');//Add a new task.
var addButton=document.querySelector('.add-task-form__button');//first button
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className='item-remove-img';
...
//select ListItems children
    ...
    var deleteButton=taskListItem.querySelector(".remove-button");
